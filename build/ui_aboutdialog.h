...
"Copyright &copy; 2011-YYYY The Youbercoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Youbercoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Youbercoin</b> version", 0));
