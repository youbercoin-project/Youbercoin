...
uint256 hashGenesisBlock("0xd412a5f2b0f6d91039a3b0898343c8da6eede6c0f1404ae328bfa6f27a786404");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd412a5f2b0f6d91039a3b0898343c8da6eede6c0f1404ae328bfa6f27a786404");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Youbercoin.Creado por Jose Ingacio";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1499951543;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1011979;
        ...
        assert(block.hashMerkleRoot == uint256("0x56d98c0d88dd847154981d816807c158a93723a1d779cd75c83b6041b28aa45d"));
